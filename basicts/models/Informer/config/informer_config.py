...
@dataclass
class InformerConfig(BasicTSModelConfig):
    ...
    prob_attn: bool = field(default=True, metadata={"help": "Whether to use ProbAttention."})
    factor: int = field(default=3, metadata={"help": "Factor in ProbAttention."})
    ...
    distill: bool = field(default=True, metadata={"help": "Whether to use distillation."})
